    ...
    <>
      ...
      >
        ...
        <p>
          ...
          the codebase. Built and maintained BikeCenter's{" "}
          <Highlight>entire component library from scratch</Highlight> using
          React, TypeScript, and SCSS—no third-party UI frameworks.
        </p>
      ...
      <Job company="Campudus" position="Intern" period="2019–2020">
        <p>
          Built a fullstack accessories ordering application from scratch
          (design, architecture, backend, frontend) during a 3-month internship
          at DealerCenter Digital's sister company.
        </p>
      </Job>
    </>
  );
